      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 py-10 md:py-14">
        ...
        {displayed.length === 0 && (
          <div className="text-center py-24">
            <h3 className="font-amiri text-2xl mb-2" style={{ color: "#999" }}>No entries found</h3>
            <p className="text-sm mb-6" style={{ color: "#bbb" }}>Try different keywords</p>
