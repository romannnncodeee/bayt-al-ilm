      ...
      <div className="animate-modal w-full max-w-3xl max-h-[92vh] flex flex-col rounded-2xl overflow-hidden shadow-2xl"
        ...
        <div className="flex-shrink-0 flex items-center justify-between px-6 md:px-8 py-4"
          ...
          <span className="text-xs font-semibold px-3 py-1 rounded-lg"
            style={{ backgroundColor: "#f5f0e8", color: "#c9973a" }}>
            {fatwa.category}
          </span>
        ...
        <div className="flex-1 overflow-y-auto px-6 md:px-8 py-6 md:py-8">
          <h2 className="font-amiri text-2xl md:text-3xl font-bold mb-6" style={{ color: "#1a1208" }}>
            {fatwa.title}
          </h2>

          {/* Ayat block for tafsir */}
          {fatwa.isTafsir && fatwa.ayat && (
            <div className="mb-6 p-4 md:p-5 rounded-xl"
              style={{ backgroundColor: "#f5f0fa", border: "1px solid #d8caf0" }}>
              <p className="text-xs font-semibold uppercase tracking-wider mb-3" style={{ color: "#7c5cbf" }}>The Ayat</p>
              <p className="text-sm md:text-base leading-relaxed ruling-text" style={{ color: "#333" }}>
                {fatwa.ayat}
              </p>
            </div>
          )}
          ...
          {!fatwa.isTafsir && (
            <div className="mb-6 p-4 md:p-5 rounded-xl"
              style={{ backgroundColor: "#fdf9f2", border: "1px solid #e8d9b0" }}>
          ...
          <div className="flex items-center gap-3 mb-5">
            <div className="h-px flex-1" style={{ backgroundColor: "#e8e0d0" }}></div>
          ...
          <div className="text-sm md:text-base ruling-text" style={{ color: "#333" }}>
            {renderText(fatwa.ruling)}
          </div>

          {/* Audio */}
          {fatwa.audio && (
            <div className="mt-6 p-4 rounded-xl" style={{ backgroundColor: "#fdf9f2", border: "1px solid #e8d9b0" }}>
        ...
        {/* Footer */}
        <div className="flex-shrink-0 flex items-center justify-between px-6 md:px-8 py-4"
          style={{ borderTop: "1px solid #e8e0d0", backgroundColor: "#fafaf8" }}>
