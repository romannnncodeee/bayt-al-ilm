...
export default function Footer() {
  return (
    <footer className="mt-20 py-12" style={{ borderTop: "1px solid #e8e0d0", backgroundColor: "#fff" }}>
      <div className="max-w-6xl mx-auto px-6 text-center">
        <p className="font-amiri text-2xl font-bold mb-1" style={{ color: "#1a1208" }}>Bayt al-Ilm</p>
        <p className="font-amiri text-lg mb-6" style={{ color: "#c9973a" }}>بيت العلم</p>
        <div className="h-px max-w-xs mx-auto mb-6" style={{ backgroundColor: "#e8e0d0" }}></div>
        <p className="text-sm leading-relaxed max-w-lg mx-auto mb-6" style={{ color: "#888" }}>
        ...
        <p className="mt-8 font-amiri text-sm" style={{ color: "#ccc" }}>
